...
with tf.Session() as sess:
    ...
    saver = tf.train.import_meta_graph('/home/test01/csw/resnet34/ckpt_with_relu_input/raw_from_pythorch_0.66516/resnet34-Pytorch.meta')
    # saver.restore(sess, '/home/test01/csw/resnet34/ckpt3_20200617/resnet-34-accTensor("accuracy:0", shape=(), dtype=float32)-5')

    saver.restore(sess, '/home/test01/csw/resnet34/ckpt_with_relu_input/resnet-34-accTensor("accuracy:0", shape=(), dtype=float32)-4')

    # saver.restore(sess, '/home/test01/csw/resnet34/ckpt_with_relu_input/raw_from_pythorch_0.66516/resnet34-Pytorch')
